export const defaultTemplates = {
    ...
    sys_sub_req: "🚨 *SUBSTITUTION DUTY ASSIGNED* 🚨\n\nHello *{name}*,\nYou have been officially assigned to cover a class for *{requesterName}*.\n\n━━━━━━━━━━━━━━━━━━━━\n📋 *ASSIGNMENT DETAILS*\n🔹 *Subject:* {subject} ({group})\n🔹 *Room:* {room}\n🔹 *When:* {day}, {date} at {time}{cofacStr}\n━━━━━━━━━━━━━━━━━━━━\n\n👉 _Please log in to the portal to formally acknowledge this duty._",
    sys_sub_app: "✅ *SUBSTITUTION APPROVED!* ✅\n\nGreat news, *{name}*!\nYour substitution arrangement for *{subject}*{cofacInline} on *{day}*, {date} has been *officially approved* by administration.\n\n📅 *Covered By*: {subName}\n\n~ *LAMS Admin*",
    sys_sub_rej: "❌ *SUBSTITUTION DECLINED* ❌\n\nHello *{name}*,\nUnfortunately, your substitution arrangement for *{subject}*{cofacInline} on *{day}*, {date} has been *declined* or cancelled.\n\nℹ️ *Info*: Please log in to check the status.",
    sys_sub_acc: "🎉 *SUBSTITUTION ACCEPTED!* 🎉\n\nHello *{name}*,\nYour assigned substitution for *{subject}*{cofacInline} on *{day}*, {date} has been *formally acknowledged* by *{subName}*!\n\n~ *LAMS Admin*",
    sys_sub_can: "⚠️ *SUBSTITUTION CANCELLED* ⚠️\n\nHello *{name}*,\nA previously assigned substitution for *{subject}*{cofacInline} on *{day}*, {date} has been *cancelled*.\n\nℹ️ *Info*: You are expected to take this class.",
