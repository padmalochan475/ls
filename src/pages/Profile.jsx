...
import { User, Mail, Phone, BadgeCheck, Shield, Key, Save, Edit2, Camera, X, Check, Eye, EyeOff } from 'lucide-react';
    ...
    const handleSaveCrop = async () => {
        ...
        try {
            ...
            reader.onloadend = async () => {
                ...
                setIsCropping(false);
                setImageSrc(null);
                // Removed auto-reload to prevent loops and allow error viewing
            };
