...
const Profile = () => {
    ...
    const stats = useMemo(() => {
        ...
        const myAssignments = assignments.filter(a => {
            ...
            const matchesId = userProfile.empId && (a.facultyEmpId && String(a.facultyEmpId).trim() === String(userProfile.empId).trim() || a.faculty2EmpId && String(a.faculty2EmpId).trim() === String(userProfile.empId).trim());
